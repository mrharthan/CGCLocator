...
namespace LRSLocator
{
    ...
    public class GetTransitCostFromLatLongHandler : IRESTHandler
    {
        ...
        double transitSpeedAvg = 0.0;
        double transitIncomeAvg = 0.0;
        short transferWaitMin = 0;        
        ...
        public object HandleRequest(RESTContext context)
        {
            ...
            try
            {
                ...
                result = idTransitFeatures(begin_longitude.Value, begin_latitude.Value, end_longitude.Value, end_latitude.Value, inputTFrame, wkid.Value);
        ...
        private byte[] idTransitFeatures(double firstX, double firstY, double lastX, double lastY, string inputTFrame, long spatialRef)
        {
            using (ComReleaser comReleaser = new ComReleaser())
            {
                ...
                first_point.Project((_context.WalkwayFeatureClass as IGeoDataset).SpatialReference);
                userPoints.Add(first_point);

                last_point.PutCoords(lastX, lastY);
                last_point.Project((_context.WalkwayFeatureClass as IGeoDataset).SpatialReference);
                ...
                traversal.SimpleRouteSetupSolveAndSaveWorkflow(_context.NetworkCGCTransit, userPoints, _context);
                ...
                foreach (IFeature mFeatures in MetricsFeatures)
                {
                    ...
                    else if (hwyID.Equals(last_rteid) && fromM <= endMeasure && toM >= endMeasure)
                    {
                        ...
                        transitSpeedAvg = Math.Round(float.Parse(mFeatures.get_Value(mFeatures.Fields.FindField(_context.LrsAutoTripMetricFeatureClass_WDAllDayAASField)).ToString()), 0);
                    else if (inputTFrame.Equals("2:EarlyAM:Weekday"))
                        transitSpeedAvg = Math.Round(float.Parse(mFeatures.get_Value(mFeatures.Fields.FindField(_context.LrsAutoTripMetricFeatureClass_WDEarlyAMAASField)).ToString()), 0);
                    else if (inputTFrame.Equals("3:PeakAM:Weekday"))
                        transitSpeedAvg = Math.Round(float.Parse(mFeatures.get_Value(mFeatures.Fields.FindField(_context.LrsAutoTripMetricFeatureClass_WDPeakAMAASField)).ToString()), 0);
                    else if (inputTFrame.Equals("4:MidDay:Weekday"))
                        transitSpeedAvg = Math.Round(float.Parse(mFeatures.get_Value(mFeatures.Fields.FindField(_context.LrsAutoTripMetricFeatureClass_WDMidDayAASField)).ToString()), 0);
                    else if (inputTFrame.Equals("5:PeakPM:Weekday"))
                        transitSpeedAvg = Math.Round(float.Parse(mFeatures.get_Value(mFeatures.Fields.FindField(_context.LrsAutoTripMetricFeatureClass_WDPeakPMAASField)).ToString()), 0);
                    else if (inputTFrame.Equals("6:LatePM:Weekday"))
                        transitSpeedAvg = Math.Round(float.Parse(mFeatures.get_Value(mFeatures.Fields.FindField(_context.LrsAutoTripMetricFeatureClass_WDLatePMAASField)).ToString()), 0);
                    else if (inputTFrame.Equals("7:AllDay:Weekend"))
                        transitSpeedAvg = Math.Round(float.Parse(mFeatures.get_Value(mFeatures.Fields.FindField(_context.LrsAutoTripMetricFeatureClass_WEAllDayAASField)).ToString()), 0);
                    else if (inputTFrame.Equals("8:EarlyAM:Weekend"))
                        transitSpeedAvg = Math.Round(float.Parse(mFeatures.get_Value(mFeatures.Fields.FindField(_context.LrsAutoTripMetricFeatureClass_WEEarlyAMAASField)).ToString()), 0);
                    else if (inputTFrame.Equals("9:PeakAM:Weekend"))
                        transitSpeedAvg = Math.Round(float.Parse(mFeatures.get_Value(mFeatures.Fields.FindField(_context.LrsAutoTripMetricFeatureClass_WEPeakAMAASField)).ToString()), 0);
                    else if (inputTFrame.Equals("10:MidDay:Weekend"))
                        transitSpeedAvg = Math.Round(float.Parse(mFeatures.get_Value(mFeatures.Fields.FindField(_context.LrsAutoTripMetricFeatureClass_WEMidDayAASField)).ToString()), 0);
                    else if (inputTFrame.Equals("11:PeakPM:Weekend"))
                        transitSpeedAvg = Math.Round(float.Parse(mFeatures.get_Value(mFeatures.Fields.FindField(_context.LrsAutoTripMetricFeatureClass_WEPeakPMAASField)).ToString()), 0);
                    else if (inputTFrame.Equals("12:LatePM:Weekend"))
                        transitSpeedAvg = Math.Round(float.Parse(mFeatures.get_Value(mFeatures.Fields.FindField(_context.LrsAutoTripMetricFeatureClass_WELatePMAASField)).ToString()), 0);
                    else
                        transitSpeedAvg = 0.0;
                    ...
                    else
                    {
                        ...
                        if (toM > fromM)
                        {
                            ...
                            if (nxtSegLen > 0.0)
                                nxtSegTime = (nxtSegLen / transitSpeedAvg) * 60;
                            else
                                nxtSegTime = 0.0;
                ...
                resultLRMData = calculateAutoResults(totalSegLen, totalSegTime, transitIncomeAvg, transferWaitMin, spatialRef);
        ...
        private List<IFeature> getMetricsLimitsFeatures(List<IFeature> limitsLRMFeatures, string dayTimeParam, string CtrlTable, bool firstFeature)
        {
            ...
            if (CtrlTable.Equals("Trip Data"))
            {
                ...
                {
                    fac_id = lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.WalkwayFeatureClass_RIDField)).ToString();  // RouteID
                    from_dfo = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.WalkwayFeatureClass_FDFOField)).ToString()), 3);  // FROM_M
                    to_dfo = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.WalkwayFeatureClass_TDFOField)).ToString()), 3);  // TO_M                    
                    if (dayTimeParam.Equals("1:AllDay:Weekday"))
                        transitSpeedAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsWalkTripMetricFeatureClass_WDAllDayAASField)).ToString()), 0);
                    else if (dayTimeParam.Equals("2:EarlyAM:Weekday"))
                        transitSpeedAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsWalkTripMetricFeatureClass_WDEarlyAMAASField)).ToString()), 0);
                    else if (dayTimeParam.Equals("3:PeakAM:Weekday"))
                        transitSpeedAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsWalkTripMetricFeatureClass_WDPeakAMAASField)).ToString()), 0);
                    else if (dayTimeParam.Equals("4:MidDay:Weekday"))
                        transitSpeedAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsWalkTripMetricFeatureClass_WDMidDayAASField)).ToString()), 0);
                    else if (dayTimeParam.Equals("5:PeakPM:Weekday"))
                        transitSpeedAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsWalkTripMetricFeatureClass_WDPeakPMAASField)).ToString()), 0);
                    else if (dayTimeParam.Equals("6:LatePM:Weekday"))
                        transitSpeedAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsWalkTripMetricFeatureClass_WDLatePMAASField)).ToString()), 0);
                    else if (dayTimeParam.Equals("7:AllDay:Weekend"))
                        transitSpeedAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsWalkTripMetricFeatureClass_WEAllDayAASField)).ToString()), 0);
                    else if (dayTimeParam.Equals("8:EarlyAM:Weekend"))
                        transitSpeedAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsWalkTripMetricFeatureClass_WEEarlyAMAASField)).ToString()), 0);
                    else if (dayTimeParam.Equals("9:PeakAM:Weekend"))
                        transitSpeedAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsWalkTripMetricFeatureClass_WEPeakAMAASField)).ToString()), 0);
                    else if (dayTimeParam.Equals("10:MidDay:Weekend"))
                        transitSpeedAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsWalkTripMetricFeatureClass_WEMidDayAASField)).ToString()), 0);
                    else if (dayTimeParam.Equals("11:PeakPM:Weekend"))
                        transitSpeedAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsWalkTripMetricFeatureClass_WEPeakPMAASField)).ToString()), 0);
                    else if (dayTimeParam.Equals("12:LatePM:Weekend"))
                        transitSpeedAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsWalkTripMetricFeatureClass_WELatePMAASField)).ToString()), 0);
                    else
                        transitSpeedAvg = 0.0;
                    if (to_dfo > from_dfo)
                    {
            ...
            else  // "Traveler Data"
            {
                foreach (IFeature lrmLimit in limitsLRMFeatures)
                {
                    fac_id = lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsAutoTravMetricFeatureClass_RIDField)).ToString();  // LINEARID
                    ...
                    if (dayTimeParam.Equals("1:AllDay:Weekday"))
                        transitIncomeAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsAutoTravMetricFeatureClass_WDAllDayAAIField)).ToString()), 0);
                    else if (dayTimeParam.Equals("2:EarlyAM:Weekday"))
                        transitIncomeAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsAutoTravMetricFeatureClass_WDEarlyAMAAIField)).ToString()), 0);
                    else if (dayTimeParam.Equals("3:PeakAM:Weekday"))
                        transitIncomeAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsAutoTravMetricFeatureClass_WDPeakAMAAIField)).ToString()), 0);
                    else if (dayTimeParam.Equals("4:MidDay:Weekday"))
                        transitIncomeAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsAutoTravMetricFeatureClass_WDMidDayAAIField)).ToString()), 0);
                    else if (dayTimeParam.Equals("5:PeakPM:Weekday"))
                        transitIncomeAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsAutoTravMetricFeatureClass_WDPeakPMAAIField)).ToString()), 0);
                    else if (dayTimeParam.Equals("6:LatePM:Weekday"))
                        transitIncomeAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsAutoTravMetricFeatureClass_WDLatePMAAIField)).ToString()), 0);
                    else if (dayTimeParam.Equals("7:AllDay:Weekend"))
                        transitIncomeAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsAutoTravMetricFeatureClass_WEAllDayAAIField)).ToString()), 0);
                    else if (dayTimeParam.Equals("8:EarlyAM:Weekend"))
                        transitIncomeAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsAutoTravMetricFeatureClass_WEEarlyAMAAIField)).ToString()), 0);
                    else if (dayTimeParam.Equals("9:PeakAM:Weekend"))
                        transitIncomeAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsAutoTravMetricFeatureClass_WEPeakAMAAIField)).ToString()), 0);
                    else if (dayTimeParam.Equals("10:MidDay:Weekend"))
                        transitIncomeAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsAutoTravMetricFeatureClass_WEMidDayAAIField)).ToString()), 0);
                    else if (dayTimeParam.Equals("11:PeakPM:Weekend"))
                        transitIncomeAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsAutoTravMetricFeatureClass_WEPeakPMAAIField)).ToString()), 0);
                    else if (dayTimeParam.Equals("12:LatePM:Weekend"))
                        transitIncomeAvg = Math.Round(float.Parse(lrmLimit.get_Value(lrmLimit.Fields.FindField(_context.LrsAutoTravMetricFeatureClass_WELatePMAAIField)).ToString()), 0);
                    else
                        transitIncomeAvg = 0.0;
                    if (to_dfo >= from_dfo)
                    {
                        // Collect qualifying feature
                        limitFeatures.Add(lrmLimit);
        ...
        private List<IFeature> findClosestFeatures(IPoint point, string eventType)
        {
            ...
            using (ComReleaser comReleaser = new ComReleaser())
            {
                ...
                foreach (var transFeature in countFeatures)
                {
                    //Find the distance from input point to this feature
                    IProximityOperator proximityOperator = transFeature.Shape as IProximityOperator;
                    ...
                    if (distance < closestDistance)
                    {
                        ...
                        {
                            closestTFeatures.Add(transFeature);
                        }
                        else
                        {
                            closestDistance = distance;
                            closestFeature = transFeature;
